"""RETIRED -- spatial n-back attention task.

Replaced by app/tasks/attention_openmatb.py, which runs OpenMATB
(juliencegarra/OpenMATB) as a subprocess: an existing, validated
sustained-attention/workload battery, chosen because the n-back's discrete
trial structure couldn't record *continuous* attention/focus. Not imported
anywhere -- kept commented out below for reference only.
"""
